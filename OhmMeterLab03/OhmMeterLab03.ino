...
lcd.begin(16, 2);                   // Definess how many rows and collumns there are on lcd being used. The first line and colunm are line and colunm 0.
...
Serial.print ("Ohms:");                       // Prints exactly what's in "" to Serial Monitor.
